        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Pioneer Mall PB.19,Kampala,Uganda.
              </li>

              <li>
                <a href="tel:+256740442029" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="lg:text-right text-custom-sm mb-4">
              Save More  With App & New User only
            </p>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved Nexcell Gadgets . <a href="https://spotnet.tech" className="text-blue hover:underline">
