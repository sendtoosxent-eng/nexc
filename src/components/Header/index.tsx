...
const Header = () => {
  ...
  const wishlistItems = useAppSelector((state) => state.wishlistReducer?.items || []); // Added wishlist selector
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-pacific"
                    >
                      <svg
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="font-medium text-custom-sm text-dark">+256 740 442 029</p>
              </div>
            </div>
          ...
          <span className="flex items-center justify-center font-medium text-[8px] absolute -right-1.5 -top-1.5 bg-pacific w-3.5 h-3.5 rounded-full text-white">
            {wishlistItems.length}
                  ...
                  <div>
                    ...
                    <p className="font-medium text-custom-sm text-dark">View</p>
                  </div>
    </Link>
    {/* ----------------------------------------------- */}
          ...
          <div className="flex items-center justify-between">
                ...
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li key={i} className="group relative before:w-0 before:h-[3px] before:bg-pacific before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full ">
                        <Link href={menuItem.path} className={`hover:text-pacific text-custom-sm font-medium text-dark flex ${stickyMenu ? "xl:py-4" : "xl:py-6"}`}>
                          {menuItem.title}
                        </Link>
                      </li>
                    )
                  ...
                  <li className="xl:hidden">
                    <Link href="/wishlist" className="hover:text-pacific text-custom-sm font-medium text-dark flex items-center gap-2">
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                ...
                <li className="py-4">
                  <Link href="/wishlist" className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-pacific">
